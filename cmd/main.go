...
import (
	...
	"github.com/maximilianoPizarro/kairos/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0e4bfd33.maximilianopizarro.github.io",
	...
	if err = (&controller.SmartScalingPolicyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SmartScalingPolicy")
		os.Exit(1)
	}
	if err = (&controller.KairosAgentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "KairosAgent")
		os.Exit(1)
	}
	if err = (&controller.KairosConsoleReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
...
func (b *defaultConsoleBootstrapper) Start(ctx context.Context) error {
	...
	console := &kairosv1alpha1.KairosConsole{
		...
		Spec: kairosv1alpha1.KairosConsoleSpec{
			Replicas: &replicas,
			Image:    "quay.io/maximilianopizarro/kairos-console:v2.0.1",
