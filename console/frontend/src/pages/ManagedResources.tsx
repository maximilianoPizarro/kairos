      ...
      {resources.length === 0 ? (
        <Card isFlat>
          <CardBody>
            <EmptyState>
              <EmptyStateHeader
                titleText="No managed resources found"
                headingLevel="h4"
                icon={<EmptyStateIcon icon={CubesIcon} />}
              />
              <EmptyStateBody>
                No resources are currently managed by Kairos. To get started:
                <br /><br />
                1. Add the annotation <code>kairos.io/managed: &quot;true&quot;</code> to your workloads<br />
                2. Deploy a KairosAgent CR to monitor and optimize resources<br />
                3. For spoke clusters, ensure agents report to the hub console via <code>hubReporting.endpoint</code>
              </EmptyStateBody>
            </EmptyState>
          </CardBody>
        </Card>
                  ...
                  {paginatedResources.length === 0 ? (
                    <Tr>
                      <Td colSpan={9} style={{ textAlign: 'center', padding: '2rem' }}>
                        No managed resources found for this cluster filter.
                      </Td>
                    </Tr>
                  ) : (
